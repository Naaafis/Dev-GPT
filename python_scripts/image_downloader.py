...
discord_token = "MTE2NTg1MDAzOTk3MzgzODg0OA.Gt75j0.sUu0mHwo1NIrp9oB9H57IJwNBJnoq3NKP3OZXc"
...
async def on_message(message):
    for attachment in message.attachments:
        ...
        if attachment.filename.lower().endswith((".png", ".jpg", ".jpeg", ".gif")):
            await attachment.save(f'/Users/jonathanshum/Desktop/EC601/output/{attachment.filename}')
